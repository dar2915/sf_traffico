...
const OperatorsProfile = () => {
  ...
  }, [searchValue, entriesPerPage, currentPageDetailsSection, startDate,
    endDate]);
  ...
  <div className="flex gap-2">
    <div className="relative flex mb-4">
      ...
      <input
        ...
        // w-400px class sets the width of the "From" input field to 400px
      />
      <label>&nbsp;To: </label>&nbsp;&nbsp;&nbsp;
      <input
        type="date"
        ...
        className="w-400px border border-sky-700 focus:outline-none focus:ring-sky-700 focus:border-sky-700 rounded-lg pl-3 pr-10 py-2 mr-4"
        // w-400px class sets the width of the "To" input field to 400px
      />
    </div>
