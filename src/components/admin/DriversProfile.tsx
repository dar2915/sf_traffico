...
const DriversProfile = () => {
  ...
  }, [searchValue, entriesPerPage, currentPageDetailsSection,startDate,endDate]);
  ...
  <div className="flex gap-2">
    <div className="relative flex items-center mb-4">
      ...
      <input
        ...
        className="w-400px border border-sky-700 focus:outline-none focus:ring-sky-700 focus:border-sky-700 rounded-lg pl-3 pr-10 py-2 mr-4"
      ...
      <input
        ...
        className="w-400px border border-sky-700 focus:outline-none focus:ring-sky-700 focus:border-sky-700 rounded-lg pl-3 pr-10 py-2"
        // Adjust the width as needed
      />
    </div>
    <div className="relative flex items-center w-full mb-4">
      <MdOutlineSearch className="absolute text-gray-400 right-3 top-1/2 transform -translate-y-1/2 text-2xl" />
      <input
        type="text"
        value={searchValue}
        onChange={(e) => {
        ...
        placeholder="Search"
        className="w-full border border-sky-700 focus:outline-none focus:ring-sky-700 focus:border-sky-700 rounded-lg pl-3 pr-10 py-2"
        // w-full class sets the width of the search input field to 100% of the container
      />
    </div>
  </div>
)}
